...
export async function initGeminiWatermarkRemoverUserscript() {
  try {
    ...
    console.log('[Gemini Watermark Remover by UKH] Initializing...');
    ...
    console.log('[Gemini Watermark Remover by UKH] Ready');
  } catch (error) {
    console.error('[Gemini Watermark Remover by UKH] Initialization failed:', error);
  }
}
